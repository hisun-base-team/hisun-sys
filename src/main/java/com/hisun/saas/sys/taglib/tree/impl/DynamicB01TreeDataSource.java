...
//
//@Component
//public class DynamicB01TreeDataSource extends TreeObject {
//	private  static  final Logger logger = LoggerFactory.getLogger(DynamicB01TreeDataSource.class);
//	@Resource
...
//				getB01TreeVoListByFl(nodeList,parentKey);
//				getB01VoListByFlId(nodeList,parentKey);
//			}else{
//				getB01TreeVoListByB01(nodeList,parentKey);
//			}
//
////			nodeList = getB01TreeVoList(dataSourceTyle, parentKey);
//		}catch (Exception e){
//			e.printStackTrace();
//		}
//		return nodeList;
...
////							nodeB01.setDynamicLoading(1);// 是否动态加载 1 为动态加载 0为否
