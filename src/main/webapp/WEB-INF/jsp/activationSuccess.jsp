...
<div class="regis_1000" style="min-height:600px;">
	...
	<c:if test="${success==true}">
		<div class="Success_tips"><img src="${path}/images/templateImage/SuccessICO.png"><span>激活成功！</span></div>
		<div class="Success_sumin">恭喜您激活成功成为优异网租户，<a href="${path}/login">马上体验</a></div>
	</c:if>
	<c:if test="${success==false}">
		<div class="Success_tips"><img src="${path}/images/templateImage/ErrorICO.png"><span>激活失败 !</span></div>
		<div class="Success_sumin">${message}</div>
