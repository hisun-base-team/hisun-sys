	...
	<div class="navbar-inner">
		...
		<div class="container-fluid">
			...
			<a class="brand" href="index.html"> <img
				src="${path }/images/templateImage/logo.png" alt="logo" />
			...
			<a href="javascript:;" class="btn-navbar collapsed"
				...
				src="${path }/images/templateImage/menu-toggler.png" alt="" />
				...
				<li class="dropdown" id="header_inbox_bar"><a href="#"
					...
					<ul class="dropdown-menu extended inbox">
						...
						<li><a href="inbox.html?a=view"> <span class="photo"><img
									src="${path }/images/templateImageavatar2.jpg" alt="" /></span> <span
						...
						<li><a href="inbox.html?a=view"> <span class="photo"><img
									src="${path }/images/templateImage/avatar3.jpg" alt="" /></span> <span
						...
						<li><a href="inbox.html?a=view"> <span class="photo"><img
									src="${path }/images/templateImage/avatar1.jpg" alt="" /></span> <span
