...
<div class="span12">
    <div class="portlet box grey">
        ...
        <div class="portlet-body form">
            <form action="${path }/sys/tenant/tenant/department/save" class="form-horizontal" id="addForm"
                  method="post">
                ...
                <div id="parentNameGroup" class="control-group">
                    ...
                    <div class="controls">
                        <Tree:tree id="parentId" valueName="parentName" treeUrl="${path}/sys/tenant/department/tree"
                ...
                <div id="sortGroup" class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="sort" name="sort" number="true" class="span6 m-wrap" required max="999"
                               value="${vo.sort}">
                    </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="javascript:returnList();" class="btn btn-default" data-dismiss="modal"><i
                            class='icon-remove-sign'></i> 取消
                    </a>
                </div>
            </form>
        </div>
