...
<div class="container-fluid">
    <div class="row-fluid">
            ...
            <shiro:hasPermission name="sys-tenant:*">
                <div class="clearfix fr">
                    <a id="sample_editable_1_new" class="btn green"
                       href="${path}/sys/tenant/tenant/add?&OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}">
        ...
        <div class="clearfix">
            <form action="${path }/sys/tenant/tenant/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}" method="post"
                  id="searchForm" name="searchForm" style="margin: 0 0 0px;">
                租户名称:
                <input type="text"  class="m-wrap" style="width: 100px;" name="name" id="name" value="${name}">
                创建日期:
                <input size="16" type="text"  class="m-wrap" readonly="" id="start" name="start" class="span12"
                       style="width: 100px;" value="${param.start }" onchange="startChange()" style="width: 90px;">
                -
                <input size="16" type="text"  class="m-wrap" readonly="" id="end" name="end" class="span12" style="width: 100px;"
                       value="${param.end }" onchange="endChange()" style="width: 90px;">
                状态:
            ...
            <table class="table table-striped table-bordered table-hover dataTable table-set">
                ...
                <c:forEach items="${pager.datas}" var="entity">
                    <tr style="text-overflow:ellipsis;">
                        <td>
                            <a href="${path}/sys/tenant/tenant/edit/${entity.id}?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}"><c:out
                                    value="${entity.name}"></c:out></a></td>
                        ...
                        <td>
                            <a href="${path }/sys/tenant/user/4admin/list?tenantId=${entity.id}&OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}">${entity.usersCount}</a>
                        </td>
