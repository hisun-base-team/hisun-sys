...
<div class="container-fluid">
                ...
                <div class="tab-content">
                    <div class="tab-pane profile-classic row-fluid active" id="tab_1_2">
                        <div class="span2"><img
                                ...
                                alt="" class="headPhoto" style="width: 238px;"/></div>
                        <ul class="unstyled span10">
                            <li><span>姓名:</span> <c:out value="${user.realname }"></c:out></li>
                            <%--<li><span>生日:</span> <c:out value="${user.birthday }"></c:out></li>--%>
                            <li><span>所在部门:</span> <c:out value="${user.departmentName}"></c:out></li>
                            <li><span>单位职务:</span> <c:out value="${user.positional }"></c:out></li>
                            ...
                            <%--<li><span>个人主页:</span> <a href="<c:out value="${user.website }"></c:out>"><c:out
                                    value="${user.website }"></c:out></a></li>--%>
                            ...
                            <div class="span12">
                                <div class="span2">
                                    <ul class="ver-inline-menu tabbable margin-bottom-10">
                                        ...
                                        <li><a data-toggle="tab" href="#tab_2-2"><i class="icon-picture"></i> 修改头像</a>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        <div id="tab_1-1" class="tab-pane active">
                                            <div style="height: auto;" id="accordion1-1" class="accordion collapse">
                                                <div class="modal-body form form-horizontal">
                                                    <form action="${path}/sys/tenant/user/update" id="infoform"
                                                          name="infoform" class="form-horizontal">
                                                        <input id="id" name="id"
                                                               value="<c:out value="${user.id}"></c:out>" type="hidden">
                                                        <input id="sex" name="sex"
                                                               value="<c:out value="${user.sex}"></c:out>"
                                                               type="hidden">
                                                        <input id="sort" name="sort"
                                                               value="<c:out value="${user.sort}"></c:out>"
                                                               type="hidden">
                                                        <input id="departmentId" name="departmentId"
                                                               value="<c:out value="${user.departmentId}"></c:out>"
                                                               type="hidden">
                                                        <div id="realnameGroup" class="control-group">
                                                            <label class="control-label">姓名<span
                                                                    class="required">*</span></label>
                                                            <div class="controls">
                                                                <input type="text" class="m-wrap span8" id="realname"
                                                                       name="realname" required
                                                                       value='<c:out value="${user.realname }"></c:out>'/>
                                                            </div>
                                                        </div>
                                                        <div id="positionalGroup" class="control-group">
                                                            <label class="control-label">单位职务<span
                                                                    class="required">*</span></label>
                                                            <div class="controls">
                                                                <input type="text" class="m-wrap span8" id="positional"
                                                                       name="positional" required
                                                                       value='<c:out value="${user.positional }"></c:out>'/>
                                                            </div>
                                                        </div>
                                                        <div id="telGroup" class="control-group">
                                                            <label class="control-label">电话<span
                                                                    class="required">*</span></label>
                                                            <div class="controls">
                                                                <input type="text" class="m-wrap span8" id="tel"
                                                                       name="tel" required
                                                                       value='<c:out value="${user.tel }"></c:out>'/>
                                                            </div>
                                                        </div>
                                                        <div id="emailGroup" class="control-group">
                                                            <label class="control-label">邮箱</label>
                                                            <div class="controls">
                                                                <input type="text" class="m-wrap span8" id="email"
                                                                       name="email" customEmail="true"
                                                                       value='<c:out value="${user.email }"></c:out>'/>
                                                            </div>
                                                        </div>
                                                        <div class="form-actions">
                                                            <a href="javaScript:;" class="btn green" id="infoSubmit"><i
                                                ...
                                                <form action="#">
                                                    <div class="controls">
                                                        <div class="thumbnail" style="width: 150px; height: 150px;">
                                                            <img src="${path}/sys/tenant/user/photo?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}"
                                                                 alt="" class="headPhoto">
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="tab_3-3" class="tab-pane">
                                            <div style="height: auto;" id="accordion3-3" class="accordion collapse">
                                                <div class="modal-body form form-horizontal">
                                                    <form action="${path}/sys/tenant/user/pwd/update" id="changePwdForm"
                                                          name="changePwdForm" method="post" class="form-horizontal">
                                                        <div id="oldPwdGroup" class="control-group">
                                                            <label class="control-label">旧密码<span
                                                                    class="required">*</span></label>
                                                            <div class="controls">
                                                                <input type="password" id="oldPwd" name="oldPwd"
                                                                       class="span6 m-wrap" required maxlength="16"
                                                                       minlength="6" placeholder="输入旧密码">
                                                            </div>
                                                        </div>
                                                        <div id="passwordGroup" class="control-group">
                                                            <label class="control-label">新密码<span
                                                                    class="required">*</span></label>
                                                            <div class="controls">
                                                                <input class="m-wrap span6" type="password"
                                                                       name="password" id="password" class="password"
                                                                       minlength="6" maxlength="16" pwdStrengh="true"
                                                                       placeholder="密码">
                                                            </div>
                                                        </div>
                                                        <div id="rePwdGroup" class="control-group">
                                                            <label class="control-label">确认新密码<span
                                                                    class="required">*</span></label>
                                                            <div class="controls">
                                                                <input class="m-wrap span6" type="password" name="rePwd"
                                                                       id="rePwd" class="password" required
                                                                       equals="password" placeholder="确认密码">
                                                            </div>
                                                        </div>
                                                        <div class="submit-btn form-actions">
                                                            <button id="changePwdSubmitBtn" type="button"
                                                                    class="btn green mybutton"><i class='icon-ok'></i>
                                                                保存
                                                            </button>
                                                        </div>
                                                    </form>
    ...
    <div id="responsive" class="modal hide fade" data-width="650">
        ...
        <div class="modal-body form">
            <form action="${path }/sys/tenant/user/update/photo" class="form-horizontal" id="photoForm" name="photoForm"
                  method="post">
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            $("#changePwdSubmitBtn").on("click", function () {
                ...
                if (bool) {
                    $.ajax({
                        url: "${path}/sys/tenant/user/pwd/check",
                        type: "get",
                ...
                $("#photoForm").ajaxSubmit({
                    ...
                    success: function (data) {
                        if (data.success == "true" || data.success == true) {
                           // $(".headPhoto").attr("src", "${path }/sys/tenant/user/photo?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}");
                          //  $("#topheadPhoto").attr("src", "${path }/sys/tenant/user/photo?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}");
                            showTip("提示", "修改成功！");
            ...
            $("#infoSubmit").on("click", function () {
                ...
                if (bool) {
                    $.ajax({
                        ...
                        success: function (json) {
                            if (json.success == false) {
                                showTip("提示", json.message, 1300);
                            } else {
                                showTip("提示", "修改成功!", 1300);
                                setTimeout(function () {
                                    window.location.reload();
                                }, 1300);
                            }
            ...
            $(".form_datetime").datetimepicker({
                format: 'yyyy-mm-dd', pickerPosition: "bottom-left",
                startView: 2,
                minView: 1,
                language: 'zh-CN',
                minView: 'month',
