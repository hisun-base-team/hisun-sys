		...
		<div class="span12">
			...
			<div class="portlet box grey">
				<div class="portlet-title">
					<div class="caption">
						<span class="hidden-480">修改单位信息</span>
					</div>
				</div>
				<div class="portlet-body form">
					<form class="form-horizontal " id="form1" method="post">
						...
						<div id="nameGroup" class="control-group">
							<label class="control-label mylabel">单位名称<span
									class="required">*</span>
							</label>
							<div class="controls">
						...
						<div id="shortNameGroup" class="control-group">
							<label class="control-label mylabel">单位简称<span
									class="required">*</span>
							</label>
							<div class="controls">
						...
						<div id="shortNamePyGroup" class="control-group">
							<label class="control-label mylabel">单位简称拼音<span
									class="required">*</span>
							</label>
							<div class="controls">
...
<script type="text/javascript">
	...
	function saveSubmit(){
		...
		if(bool){
			myLoading.show();
			$.ajax({
				url : "${path}/sys/tenant/tenant/update/own",
				type : "post",
