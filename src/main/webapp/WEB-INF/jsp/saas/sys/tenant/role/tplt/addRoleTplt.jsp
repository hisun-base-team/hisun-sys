		...
		<div class="span12">
			...
			<div class="portlet box grey">
				<div class="portlet-title">
					<div class="caption">
						<span class="hidden-480">添加角色模板</span>
					</div>
				</div>
				<div class="portlet-body form">
					<!-- BEGIN FORM-->
					<form action="${path }/sys/tenant/role/tplt/save" class="form-horizontal" id="addForm" method="post">
						<div id="roleNameGroup" class="control-group">
							<label class="control-label">角色名称<span class="required">*</span></label>
							<div class="controls">
								<input type="text" id="roleName" name="roleName" class="span6 m-wrap" required maxlength="100">
						...
						<div class="control-group" id="roleCodePrefixGroup">
							...
							<div class="controls">
								<input type="text" id="roleCodePrefix" name="roleCodePrefix" class="span6 m-wrap" required maxlength="100" placeholder="唯一标示">
							</div>
						...
						<div class="control-group" id="resourceNamesGroup">
							...
							<div class="controls">
								<Tree:tree id="resourceIds" valueName="resourceNames"  treeUrl="${path}/sys/tenant/resource/select/tree" token="${sessionScope.OWASP_CSRFTOKEN}"
										   ...
										   dataType="json" isSearch="false" isSelectTree="true" chkboxType="'Y':'ps','N':'ps'" />
							</div>
						</div>
						<div class="control-group" id="roleDescriptionGroup">
							<label class="control-label">备注</label>
							<div class="controls">
								<textarea id="roleDescription" name="roleDescription" class="span6 m-wrap" maxlength="200" rows="5"></textarea>
							</div>
						</div>
			...
			if(bool){
				localPost("${path}/sys/tenant/role/tplt/code/check",{
					...
					if(!data.success){
						...
						$.ajax({
							url : "${path}/sys/tenant/role/tplt/save",
							type : "post",
