...
<body>
				...
				<div class="row-fluid profile">
						...
						<div class="tabbable tabbable-custom tabbable-full-width">
							...
							<div class="tab-content">
								...
								<div class="tab-pane profile-classic row-fluid active" id="tab_1_2">
									...
									<div class="span2"><img src="${path }/sys/admin/user/photo/${headPhoto}?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}" alt=""  class="headPhoto" style="width: 238px;"/></div>
												...
												<div class="tab-content">
													...
													<div id="tab_1-1" class="tab-pane active">
														...
														<div style="height: auto;" id="accordion1-1" class="accordion collapse">
															...
															<form action="${path }/sys/admin/user/update" id="infoform" name="infoform"  class="form-horizontal">
																<div id="realnameGroup" class="control-group">
																	<label class="control-label">真实姓名<span class="required">*</span></label>
																	<div class="controls">
																	<input type="text" class="m-wrap span8" id="realname" name="realname" required value='${cloud:htmlEscape(user.realname)}'/>
																	</div>
																</div>
																<div id="emailGroup" class="control-group">
																	...
																	<div class="controls">
																	<input type="text" class="m-wrap span8"  id="email" name="email" required customEmail="true" uniqueEmail="true" value='${cloud:htmlEscape(user.email)}'/>
																	</div>
																</div>
																<div id="telGroup" class="control-group">
																	...
																	<div class="controls">
																	<input type="text" class="m-wrap span8"  id="tel" name="tel" required value='${cloud:htmlEscape(user.tel)}'/>
																	</div>
																</div>
																...
																<div id="positionalGroup" class="control-group">
																	...
																	<div class="controls">
																	<input type="text" class="m-wrap span8" id="positional" name="positional" required value='${cloud:htmlEscape(user.positional)}'/>
																	</div>
																</div>
										...
										<a href="javaScript:;" class="btn green" id="infoSubmit"><i class='icon-ok'></i> 确定</a>
															...
															<form action="#">
																<div class="controls">
																	...
																	<div class="thumbnail" style="width: 150px; height: 150px;">
																		...
																		<img src="${path }/sys/admin/user/photo/${headPhoto}?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}" alt="" class="headPhoto">
													...
													<div id="tab_3-3" class="tab-pane">
														...
														<div style="height: auto;" id="accordion3-3" class="accordion collapse">
															<div class="modal-body form form-horizontal">
															<form action="${path}/sys/admin/user/changePwd"  id="changePwdForm" name="changePwdForm" method="post" class="form-horizontal">
					...
					<div id="responsive" class="modal hide fade" data-width="650">
							...
							<div class="modal-body form">
								...
								<form action="${path }/sys/admin/user/update/photo" class="form-horizontal" id="photoForm" name="photoForm" method="post">
	...
	jQuery.validator.addMethod("uniqueEmail", function(value, element) {
		...
		var bool;
		$.ajax({
			url : "${path }/sys/admin/user/checkEmail?email=" + value,
			type : "GET",
			async : false,
			dataType : "json",
			headers: {
	...
	var myVld = new EstValidate2("changePwdForm");
		...
		jQuery(document).ready(function() {
			...
			$("#changePwdSubmitBtn").on("click",function(){
				...
				if(bool){
					$.ajax({
						url : "${path}/sys/admin/user/checkOldPwd",
						type : "get",
				...
				$("#photoForm").ajaxSubmit({
							...
							success : function(data) {
								if (data.success == "true" || data.success == true) {
									$(".headPhoto").attr("src","${path }/sys/admin/user/photo/"+data.photoName+"?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}");
									$("#topheadPhoto").attr("src","${path }/sys/admin/user/photo/"+data.photoName+"?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}");
									showTip("提示", "修改成功！");
			   ...
			   if(bool){
			        $('.success-toggle-button').toggleButtons({
			        	onChange: function ($el, status, e) {
			        		...
			        		//var status = !status;
			        		  $.ajax({
			      				url : "${path }/sys/admin/message/user/conf/update",
			      				type : "POST",
		   ...
		   $("#upload").on("click",function(){
			...
			$("#infoSubmit").on("click",function(){
				...
				if(bool){
					$.ajax({
						url : "${path }/sys/admin/user/update",
						type : "POST",
