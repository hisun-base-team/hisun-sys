...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="clearfix">
            <form action="${path}/sys/admin/log/me/security" id="getLogForm" style="margin: 0 0 10px;" method="get"
                  class="form-horizontal">
                <input type="hidden" name="OWASP_CSRFTOKEN" value="${sessionScope.OWASP_CSRFTOKEN}">
                开始日期：
                <div class="input-append" id="starttimeDiv">
                    <input type="text" class="span12" style="width: 100px;"
                           value='<c:out value="${param.start }"></c:out>' name="start" id="start" readonly/>
                </div>
                <span class="inp_name" style="">结束日期：</span>
                <div class="input-append" id="endtimeDiv">
                    <input type="text" class="span12" style="width: 100px;"
                           value='<c:out value="${param.end }"></c:out>' name="end" id="end" readonly/>
                </div>
