...
<div class="span12">
	...
	<div class="portlet box grey">
		<div class="portlet-title">
			<div class="caption">
				<span class="hidden-480">修改目录类型</span>
			</div>
		</div>
		<div class="portlet-body form">
			...
			<form action="${path }/sys/admin/dictionary/save" class="form-horizontal" id="addForm" method="post">
				...
				<div id="pcsjValueGroup" class="control-group">
					...
					<div class="controls">
						<input size="16" type="text"  class="span6 m-wrap" readonly value="${vo.catalogCode}" id="catalogCode" name="catalogCode" value="${vo.catalogCode}">
					</div>
				</div>

				<div class="form-actions">
					<button id="submitbut" type="button" class="btn green" ><i class='icon-ok'></i> 确定</button>
...
<script type="text/javascript">
	...
	$(function(){
		$("#submitbut").on("click",function(){
			...
			if(bool){
				$.ajax({
					url : "${path}/sys/admin/dzda/catalogType/update",
					type : "post",
