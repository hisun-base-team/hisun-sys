var UITree = function () {
    ...
    return {
        ...
        init: function () {
            ...
            // handle collapse/expand for tree_2  //.css('background','red')
...
/*$(function(){
	$('#tree_1 li ul li').click(function(e) {
...
$(function(){
	$('.dropdown-menu li.Column') .hover(function(e) {
        $(this).find('.sherr_menu').show();
	},function(){
		$(this).find('.sherr_menu').hide();
    });
	
	$('.sherr_menu').hover(function(e) {
