...
var webFXTreeConfig = {
	rootIcon        : '/common/images/foldericon.png',
	openRootIcon    : '/common/images/openfoldericon.png',
	folderIcon      : '/common/images/foldericon.png',
	openFolderIcon  : '/common/images/openfoldericon.png',
	fileIcon        : '/common/images/file.png',
	iIcon           : '/common/images/I.png',
	lIcon           : '/common/images/L.png',
	lMinusIcon      : '/common/images/Lminus.png',
	lPlusIcon       : '/common/images/Lplus.png',
	tIcon           : '/common/images/T.png',
	tMinusIcon      : '/common/images/Tminus.png',
	tPlusIcon       : '/common/images/Tplus.png',
	blankIcon       : '/common/images/blank.png',
...
WebFXTreeAbstractNode.prototype.getChildSize = function() {
...
WebFXTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	//label = label.replace('<', '&lt;');
	//label = label.replace('>', '&gt;');
	var str = "<div style=\"cursor:hand\" ondblclick=\"webFXTreeHandler.toggle(this);\" id=\"" + this.id + "\"  class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this)\">";
	str += indent;
	str += "<img id=\"" + this.id + "-plus\" src=\"" + ((this.folder)?((this.open)?((this.parentNode._last)?webFXTreeConfig.lMinusIcon:webFXTreeConfig.tMinusIcon):((this.parentNode._last)?webFXTreeConfig.lPlusIcon:webFXTreeConfig.tPlusIcon)):((this.parentNode._last)?webFXTreeConfig.lIcon:webFXTreeConfig.tIcon)) + "\" onclick=\"webFXTreeHandler.toggle(this);\">"
	//str += "<img id=\"" + this.id + "-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\"><a href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" onblur=\"webFXTreeHandler.blur(this);\" >" + label + "</a></div>";
	str += "<a onclick=\""+this.action+"\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" onblur=\"webFXTreeHandler.blur(this);\" >" + label + "</a></div>";
	str += "<div id=\"" + this.id + "-cont\" class=\"webfx-tree-container\" style=\"display: " + ((this.open)?'block':'none') + ";\">";
	for (var i = 0; i < this.childNodes.length; i++) {
		str += this.childNodes[i].toString(i,this.childNodes.length);
	}
