    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar').on('click', '.sidebar-toggler', function (e) {            
            ...
            if (body.hasClass("page-sidebar-closed")) {
            	...
            	//还原滚动条的属性
            	var arr = $(".page-sidebar-closed .slimScrollDiv");
				if(arr.length>0){
					for(var i=0;i<arr.length;i++){
						var target = arr[i];
						target.style.overflow = "hidden";
						$(target).find(".scroller")[0].style.overflow = "hidden";
					}
				}
...
//            });
    ...
    return {
        ...
        init: function () {
            ...
            $("li[resid="+leftMenusid+"]").addClass("active");
        },
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="./media/images/templateImage/ajax-loading.gif" align="">',
...
function localPost( url, data, callback, dataType , headers) {
    // shift arguments if data argument was omited
    if ( jQuery.isFunction( data ) ) {
        headers = headers || dataType || callback;
